...
TEST(Camera, RendersAccurate) {
    ...
    camera.SetAim(1, 0, 0);
    camera.Render(false);
    std::filesystem::remove("/home/zc/code/birp/cpp/data/output/testout.dat"); // remove residual files

    camera.ToDat("/home/zc/code/birp/cpp/data/output/testout"); // out in readable format
        
    std::fstream fin; 
    std::fstream infile("/home/zc/code/birp/cpp/data/output/testout.dat"); // read output from birp
